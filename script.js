...
function showResult() {
  ...
  const msg = encodeURIComponent(`Hi Cristina! I completed the Financial Protection Score assessment. My score is ${score}/100 and my biggest gap appears to be ${gap}. I'd like to book a free consultation.`);
  document.getElementById("messengerLink").href = `https://m.me/cristinacruzinocencio?text=${msg}`;
}
